...
# -------------------------
# AR1 (phi = 0.4)
deep_ar1_04 <- read.csv( "deep.ar1(04).csv")
...
# -------------------------
# AR1 (phi = 0.6)
deep_ar1_06 <- read.csv( "deep.ar1(06).csv")
...
# -------------------------
# AR2 (0.4, 0.2)
deep_ar2_0402 <- read.csv( "deep.ar2(0402).csv")
...
# -------------------------
# AR2 (0.4, 0.5)
deep_ar2_0405 <- read.csv( "deep.ar2(0405).csv")
...
# -------------------------
# ARMA (0.4, 0.2)
deep_arma <- read.csv( "deep.arma.csv")
...
write.csv(mildeep, "mildeep.csv", row.names = FALSE)
