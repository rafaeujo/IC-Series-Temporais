...
**Tabela 5:** Resultados dos cálculos do RMSE com dados faltantes foram substituidos pela mediana (n=1000)

Na Tabela 5 é possível observar novamente que não há diferença clara entre os métodos de imputação pela média e pela mediana. As considerações feitas à respeito da Tabela 4 também são válidas para a Tabela 5.
...
**Tabela 6:** Resultados dos cálculos do RMSE com dados faltantes foram substituidos atravéz do método LOCF (n = 1000)

A Tabela 6 apresentou um padrão de comportamento do RMSE semelhante ao observado na comparação entre o método LOCF e as imputações por média e mediana com 100 observações. O aumento geral do RMSE, previamente identificado nas simulações com $n=1000$, também foi constatado nesta análise.
...
![](Gráficos/Gráfico Imputação com média.png){fig-align="center"}

------------------------------------------------------------------------

![](Gráficos/Grafico imputação mediana.png)

------------------------------------------------------------------------

![](Gráficos/Imputação com LOCF down.png)

------------------------------------------------------------------------

![](Gráficos/Imputação com NOCB.png)
